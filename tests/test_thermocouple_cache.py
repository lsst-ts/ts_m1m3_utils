...
class ThermocoupleCacheTestCase(unittest.TestCase):
    ...
    def test_max_missing(self) -> None:
        ...
        thermocouple = find_thermocouple(Scanner.TS_01, ThermocoupleCache.CHANNELS_PER_MESSAGE + 1)
    ...
    def test_invalid_messages(self) -> None:
        cache = ThermocoupleCache()
        temperatures = [DEFAULT_TEMPERATURE] * ThermocoupleCache.CHANNELS_PER_MESSAGE
