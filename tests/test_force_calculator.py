...
class ForceCalculatorTestCase(unittest.TestCase):
    ...
    def test_acceleration(self) -> None:
        ...
        np.testing.assert_array_equal(acceleration.xForces, [0] * FATABLE_XFA)
    ...
    def test_velocity(self) -> None:
        ...
        np.testing.assert_array_equal(velocity.xForces, [0] * FATABLE_XFA)
        np.testing.assert_array_equal(velocity.yForces, [0] * FATABLE_YFA)
        np.testing.assert_array_equal(velocity.zForces, [0] * FATABLE_ZFA)
